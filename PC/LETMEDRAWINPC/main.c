...
// Je crois bien qu'avec L'interface Graphique ça va être pire encore...
...
//int main(void) {
    ...
    //
    // if (CreateInputMouse(&inputs[LBUTTON], inputSize[4],MOUSEEVENTF_RIGHTDOWN,MOUSEEVENTF_RIGHTUP) < 0) {
    ...
    // }
    //
    // if (CreateInputMouse(&inputs[RBUTTON], inputSize[5],MOUSEEVENTF_LEFTDOWN,MOUSEEVENTF_LEFTUP) < 0) {
    //     printf("CreateInputMouse failed\n");
    //
    //     for (int i = 0; i < 5; i++) {
    //         const unsigned int a = SendInput(inputSize[i], inputs[i][1], sizeof(INPUT));
